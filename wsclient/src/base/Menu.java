...
import service.endpoint.SushiServiceService;

import types.ListOfSushi;

import types.Sushi;

import service.endpoint.SushiDirectoryServiceService;
...
public class Menu extends javax.swing.JFrame {
    ...
    static SushiServiceService sushiService = null;
    static SushiDirectoryServiceService sushiDirectoryService = null;
    
    static{

sushiService = new SushiServiceService();

}
    static{

sushiDirectoryService = new SushiDirectoryServiceService();
    ...
    private void directoryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_directoryButtonActionPerformed
        ...
        model = (DefaultTableModel) directoryTable.getModel();
        
        try{
        output2(sushiDirectoryService.getSushiDirectoryServicePort().getAllSushiDirectory());
        }catch (Exception ex) {
...
// TODO add your handling code here:
    ...
    private void addSushiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSushiButtonActionPerformed
        ...
        el.setName(sushiNameCombobox.getSelectedItem().toString());

        el.setQuantity((int) sushiQuantity.getValue());

        el.setWeight(sushiWeight.getValue());

        el.setPrice(sushiPrice.getValue());

        try {

            output(sushiService.getSushiServicePort().setNewSushi(el));
    ...
    private void sushiWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_sushiWindowOpened
        model = (DefaultTableModel) sushiTable.getModel();       // TODO add your handling code here:
    ...
    private void calculateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculateButtonActionPerformed
        try{
        priceOfOrder.setText(Integer.toString(sushiService.getSushiServicePort().getSumOfSushi()));
        }
        catch(Exception ex){
...
// TODO add your handling code here:
    ...
    private void addNewItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewItemActionPerformed
        ...
        SushiDirectory el = new SushiDirectory();

        el.setItemName(itemName.getText().toString());
        el.setItemType(typeCombobox.getSelectedItem().toString());
        el.setItemDescription(itemDescriptionField.getText().toString());

        try {

            output2(sushiDirectoryService.getSushiDirectoryServicePort().setNewSushiDirectory(el));
    ...
    private void deleteDirectoryRowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDirectoryRowActionPerformed
        if (directoryTable.getSelectedRowCount() == 1) {
            model.removeRow(directoryTable.getSelectedRow());
        } else {
    ...
    private void output(ListOfSushi lstSushi) {

        clearTable();

        int i = 1;

        for (Sushi sushi : lstSushi.getItem()) {
    ...
    private void output2(ListOfSushiDirectory lstSushiDirectory) {

        clearTable();

        for (SushiDirectory sushidirectory : lstSushiDirectory.getItem()) {
